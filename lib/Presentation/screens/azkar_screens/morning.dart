...
class MorningAzkar extends StatelessWidget {
  ...
  const MorningAzkar({super.key, required this.title, this.onProgressChanged});
      ...
      body: BlocProvider(
        ...
        child: AzkarModelView(
          ...
          azkarList: const [
            ...
            'أَصْبَحْنَا عَلَى فِطْرَةِ الْإِسْلَامِ ، وَكَلِمَةِ الْإِخْلَاصِ ، وَدِينِ نَبِيِّنَا مُحَمَّدٍ ، وَمِلَّةِ أَبِينَا إِبْرَاهِيمَ حَنِيفًا مُسْلِمًا ، وَمَا أَنَا مِنَ الْمُشْرِكِينَ [ وَمَا كَانَ مِنَ الْمُشْرِكِينَ ]',
