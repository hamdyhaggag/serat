...
import 'package:serat/Presentation/screens/azkar_screens/Pray_Azkar/Wodoo/wodoo1.dart';
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const Wodoo1()),
                );
              },
            ...
            InkWell(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const Wodoo2()),
                );
              },
